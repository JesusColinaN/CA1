...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('PaddysCafe.xml', function(err, result) {
      ...
      result.barmenu.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price, 'quantity': obj.quantity}); //If your XML elements are differet, this is where you have to change to your own element names
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('PaddysCafe.xml', function(err, result) {
      ...
      delete result.barmenu.section[obj.section].entree[obj.entree];
